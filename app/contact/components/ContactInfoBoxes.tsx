...
export function ContactInfoBoxes() {
  ...
  return (
    <div className="space-y-6">
      {/* Address Box */}
      <div className="bg-white dark:bg-zinc-800 rounded-2xl sm:rounded-3xl p-6 sm:p-8 border border-zinc-200 dark:border-zinc-700">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-base text-zinc-900 dark:text-zinc-100 mb-4">
              ...
              {t.contact.info.phone.numbers.map((number, index) => (
                <div key={index}>
                  <a
                    ...
                    className="block text-base text-zinc-900 dark:text-zinc-100 hover:text-[#9D7F5F] transition-colors"
                  >
                    {number.phone}
                  </a>
                  <span className="text-sm text-zinc-600 dark:text-zinc-400">{number.name}</span>
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <a
              ...
              className="text-base text-zinc-900 dark:text-zinc-100 hover:text-[#9D7F5F] transition-colors"
            >
