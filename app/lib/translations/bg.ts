...
export const bg: Translations = {
    ...
    exploreSections: {
      theVilla: {
        ...
        items: [
          ...
          {
            label: 'План на етажа',
            description: 'Преглед на оформлението на апартаментите.',
            href: '/floor-plan',
            icon: 'Layout',
          },
        ],
  ...
  home: {
    ...
    villas: {
      intro: {
        headline: 'Два Отделни апартамента\nПроектирани за Комфорт и Гъвкавост',
        description: 'Всяки апартамент предлага уникално преживяване, пригодено към вашите нужди. Независимо дали търсите просторни помещения за семейни събирания или уютно убежище за интимни моменти, нашите апартаменти съчетават модерен комфорт с внимателен дизайн, за да създадат незабравими престои.',
      },
      villa1: {
    ...
    amenities: {
      intro: {
        ...
        paragraphs: [
          'Апартамент "Абстракт" предлага комфортен дом далеч от вкъщи, само на 4 минути пеша от плажа и таверните. Насладете се на прекрасното гръцко море и се насладете на спокойствие и релакс в Паралия Офринио.',
      ...
      items: [
        ...
        },
        {
          ...
          description: 'Лична баня с тоалетна за вашето ползване',
        },
        {
          icon: 'washer',
          title: 'Пералня',
        ...
        },
        {
          ...
          description: 'Гледайте любимите си предавания в основната жилищна зона',
        },
        {
          icon: 'wifi',
          title: 'WiFi',
      ...
      details: {
        ...
        paragraphs: [
          ...
          'Апартаментът се намира на 4 минути пешеходно разстояние от плажа и таверните. Насладете се на близо 60 таверни, в които може да опитате ароматно гръцко кафе, сочни морски дарове, прясна риба или хрупкави тиквички.',
    ...
    journey: {
      ...
      intro: 'Нашите апартаменти се намират в Паралия Офринио, лесно достъпни с кола от България или чрез летище Солун. Отворете картата по-долу за точна навигация и указания до вашата дестинация.',
  ...
  floorPlan: {
    title: 'План на етажа',
    description: 'Преглед на оформлението на апартаментите за Abstract Apartment и Abstract Studio.',
  ...
  gallery: {
    title: 'Галерия',
    description: 'Разгледайте нашите пространства през внимателно подбрани изображения, показващи комфорта и елегантността на Abstract Apartment и Abstract Studio.',
  ...
  guide: {
    ...
    description: 'Паралия Офринио е перфектно разположен между морето, планината и културните забележителности на Северна Гърция. Оттук лесно можете да организирате еднодневни пътувания до пещери, древни градове, еко пътеки и живописни места, а вечер да се върнете в спокойствието на морския курорт.',
    reserve: 'Резервирай',
  ...
  about: {
    hero: {
      ...
      subtitle: 'Спокойно местенце до морето в Паралия Офринио. Комфорт и всичко необходимо за спокойна почивка на няколко минути пеша от плажа.',
      ctaPrimary: 'Разгледай апартаментите',
      ctaSecondary: 'Виж галерията',
    },
    story: {
      eyebrow: 'НАШАТА ИСТОРИЯ',
      title: 'Нашето местенце до морето',
      paragraphs: [
        'Здравейте, ние сме Кристина и Никола. Нашият апартамент и студио "Абстракт" в Паралия Офринио не са просто място за почивка – те са дом, роден от любов.',
        'Тук, под златния залез над Егейско море, се сгодихме и този вълшебен момент ни вдъхнови да създадем уютно и стилно пространство за незабравими летни спомени.',
        'Всяка стая носи романтика, спокойствие и грижа към детайла. Вярваме, че магията на това място ще ви накара да се влюбите – в морето, в залезите и в усещането да сте точно там, където трябва.',
        'Добре дошли в нашата сбъдната мечта.',
      ],
    },
    values: [
      {
        title: 'Комфорт на първо място',
        description: 'Всеки детайл е обмислен за вашето удобство и спокойствие.',
        icon: 'Home',
      },
      {
    ...
    team: {
      ...
      paragraphs: [
        'Ние сме местен екип, посветен на осигуряването на приятен и безпроблемен престой. Готови сме да отговорим на въпроси, да дадем съвети за местни забележителности и да направим престоя ви максимално удобен.',
        'Нашата цел е да се чувствате добре дошли и обгрижени от момента на пристигането до напускането.',
      ],
      cta: 'Свържи се с нас',
      members: [
        {
  ...
  rates: {
    ...
    section: {
      title: 'Цени',
      caption: 'Цените подлежат на промяна. За най-точна цена, потърсете желаните дати по-горе.',
    },
    units: {
      apartment: {
  ...
  details: {
    hero: {
      ...
      highlights: [
        { text: '4 мин до плажа', icon: 'MapPin' },
    ...
    general: {
      ...
      paragraphs: [
        ...
        '4 минути пеша до плажа и таверните',
    ...
    apartment: {
      ...
      rooms: [
        ...
        { label: 'Баня', details: 'Пералня', icon: 'Bath' },
    ...
    studio: {
      ...
      rooms: [
        { label: 'Основна спална зона', details: '1 легло, климатик', icon: 'Bed' },
        { label: 'Всекидневна', details: '1 диван', icon: 'Sofa' },
        { label: 'Баня', details: '1 баня', icon: 'Bath' },
      ],
      amenities: [
        { title: 'Напълно оборудвана кухня', icon: 'CookingPot' },
        { title: 'Бърз Wi-Fi', icon: 'Wifi' },
  ...
  reviews: {
    ...
    sectionSubtitle: 'Истински преживявания от нашите гости',
  ...
  pageDescriptions: {
    home: 'Изживейте луксозен престой до морето в Abstract Apartment в Паралия Офринио, Гърция. Просторен апартамент и уютно студио с невероятна морска гледка, само на 4 минути пеша от плажа. Резервирайте вашата перфектна почивка днес.',
