  ...
  admin: {
    ...
    dashboard: {
      ...
      form: {
        ...
        cleaningHours: 'Часове Почистване',
        comments: 'Коментари',
      ...
      expenses: {
        ...
        name: 'Име',
        month: 'Месец (по избор)',
        year: 'Година',
        price: 'Цена (€)',
        actions: 'Действия',
        save: 'Запази',
        cancel: 'Отказ',
        noExpenses: 'Няма намерени разходи',
        deleteConfirm: 'Сигурни ли сте, че искате да изтриете този разход?',
        addSuccess: 'Разходът е добавен',
        updateSuccess: 'Разходът е обновен',
        deleteSuccess: 'Разходът е изтрит',
        loadError: 'Неуспешно зареждане на разходите',
        operationError: 'Операцията беше неуспешна',
      },
      statistics: {
        loading: 'Зареждане на статистика...',
        error: 'Неуспешно зареждане на статистика',
        allTime: 'Общо за всички времена',
        byYear: 'По година',
        byMonth: 'По месец',
        revenue: 'Приходи',
        expenses: 'Разходи (вкл. Почистване)',
        profit: 'Печалба',
      },
    },
  },
