...
export const bg: Translations = {
  ...
  gallery: {
    ...
    sections: [
      ...
      },
      {
        ...
        title: 'Abstract Apartment - Жилищни пространства',
        images: [
          {
  ...
  guide: {
    ...
    description: 'Препоръчани места наблизо за храна, плажове, разходки, събития и лесни еднодневни екскурзии. Открийте най-доброто от Паралия Офринио и околността.',
    reserve: 'Резервирай',
