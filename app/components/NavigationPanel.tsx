...
export function NavigationPanel({ sections, featuredCard }: NavigationPanelProps) {
  return (
    <div className="absolute top-full left-0 right-0 mt-2 bg-white rounded-lg shadow-xl border border-zinc-200 py-6 px-8 z-50">
            ...
            <div className="rounded-lg overflow-hidden bg-zinc-50 border border-zinc-200">
              ...
              <div className="p-4">
                ...
                <Link
                  ...
                  className="text-sm font-medium text-[#9D7F5F] hover:text-[#8B6F47] transition-colors"
                >
